...
@csrf
  ...
  <div class="container" style="background-color:#f1f1f1;height:60px;text-align:center;">
    <p>Don't Have an account please contact the admin.</a></p></span>
  </div>
</form>-->
                  ...
                  <div class="row text-center">
                    <div class="col-12 align-self-baseline">
                                 <div style="margin: 20px 0;"> </div>
                                    <h1 class="text-white text-center mt-3 mb-3">Admin Login</h1>
                                      <form id="login" method="POST" class="login__form" action="{{route('check')}}" novalidate="novalidate">
                                        @csrf
                                        ...
                                        <div class="form-group" style="position: relative;">
                                          ...
                                          <input type="password" name="password" autocomplete="on" id="password" class="form-control valid" aria-invalid="false" placeholder="Enter Your Password">
                                          <span class="text-danger">@error('password') {{ $message }}@enderror</span>
