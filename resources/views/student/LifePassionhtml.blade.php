        ...
        <div class="profile_outerline profile_outerline_overview" data-id="9310" draggable="true" role="option" aria-grabbed="false">
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    @if($item['school_approved']==0) <p style="float: right; margin: 10px 0;">&nbsp;<span class="lifepassion_edit" style="display:block;" data-id="9313" onclick="lifepassionedit({{$item['id']}})"><i class="fa fa-pen" aria-hidden="true"></i></span></p> @endif
                </div>
