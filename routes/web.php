...
Route::get('logout',[App\Http\Controllers\StudentController::class, 'logout'])->name('logout');
...
Route::post('edit',[App\Http\Controllers\StudentController::class, 'update'])->name('update');
Route::post('editrole',[App\Http\Controllers\StudentController::class, 'updaterole'])->name('updaterole');
Route::post('editpermission',[App\Http\Controllers\StudentController::class, 'updatepermission'])->name=('updatepermission');
